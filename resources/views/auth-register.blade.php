...
<head>
    ...
    <link rel="shortcut icon" type="image/x-icon" href="../../../app-assets/images/ico/logo.ico">
                    ...
                    <div class="auth-inner row m-0">
                        ...
                        <div class="d-flex col-lg-4 align-items-center auth-bg px-2 p-lg-5">
                            <div class="col-12 col-sm-8 col-md-6 col-lg-12 px-xl-2 mx-auto">
                                ...
                                <p class="text-center mt-2"><span>Already have an account?</span><a href="/auth-log"><span>&nbsp;Sign in instead</span></a></p>
